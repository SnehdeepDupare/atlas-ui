...
```bash
npx shadcn@latest add https://atlasui.vercel.app/r/scroll-based-character-reveal.json
```
...
```bash
npx shadcn@latest add https://atlasui.vercel.app/r/scroll-based-character-reveal-html.json
```
