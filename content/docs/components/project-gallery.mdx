...
Here's a [full page preview](https://atlasui.vercel.app/preview/project-gallery) of this component.
...
```bash
npx shadcn@latest add https://atlasui.vercel.app/r/project-gallery.json
```
...
```bash
npx shadcn@latest add https://atlasui.vercel.app/r/project-gallery-js.json
```
...
<section id="interactive-modal" class="interactive-modal">
  ...
  <div class="modal" id="modal">
    <div class="modal-images" id="modal-images">
      ...
      <div class="modal-image" data-index="2" style="background-color: #fafbfc">
        <img
          src="https://images.unsplash.com/photo-1540652980807-db4655e8fa60?q=80&w=2130&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          alt="Tokyo Art"
        />
      </div>
      <div class="modal-image" data-index="3" style="background-color: #404040">
        <img
          src="https://images.unsplash.com/photo-1515705576963-95cad62945b6?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          alt="Milky Way"
        />
...
```tsx
import { Project, ProjectGallery } from "@/components/(react)/project-gallery";
```
