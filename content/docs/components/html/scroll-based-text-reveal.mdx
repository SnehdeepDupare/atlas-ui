...
<HtmlPreview name="scroll-based-text-reveal-html-demo" />
...
<ComponentSource name="scroll-based-text-reveal-html" file="css" />

<Step>Add `script.js`</Step>

<ComponentSource name="scroll-based-text-reveal-html" file="js" />
