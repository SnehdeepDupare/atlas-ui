...
<HtmlPreview name="hacker-text-html-demo" />
...
<ComponentSource name="hacker-text-html" file="css" title="style.css" />

<Step>Add `script.js`.</Step>

<ComponentSource name="hacker-text-html" file="js" title="script.js" />
