...
| `animateOnScroll` | `boolean`         | `true`  | Whether to animate on scroll, if set to false it will animate immediately |
...
| `data-animate-on-scroll` | `boolean` | `true`  | Whether to animate on scroll, if set to false it will animate immediately |
