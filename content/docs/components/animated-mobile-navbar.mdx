...
```bash
npx shadcn@latest add https://atlasui.vercel.app/r/animated-mobile-navbar.json
```
...
```bash
npx shadcn@latest add https://atlasui.vercel.app/r/animated-mobile-navbar-js.json
```
...
> **NOTE:** The `side` property is currently available only for React version. The Vanilla JS version will be added soon.
