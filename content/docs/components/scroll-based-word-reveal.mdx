...
```bash
npx shadcn@latest add https://atlasui.vercel.app/r/scroll-based-word-reveal.json
```
...
```bash
npx shadcn@latest add https://atlasui.vercel.app/r/scroll-based-word-reveal-html.json
```
