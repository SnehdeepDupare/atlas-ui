  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-20 text-center lg:px-8">
      ...
      <RevealEffect delay={0.3} translateY={10}>
        <p className="text-muted-foreground mx-auto mt-5 max-w-2xl text-sm text-balance md:text-base">
